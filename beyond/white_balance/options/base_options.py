...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--wb_action',type=str, default='wbc', help='path to our dataset IHD')
        ...
        parser.add_argument('--use_patch', action='store_true', help='global light only use trd')
