...
# def print_model_flops(model, inputs=None, pixel_pos=None): #input
def print_model_flops(model, inputs=None, background=None, patch_pos=None, mask=None): #retinextr
    list_conv=[]
    ...
    # output = model(inputs=inputs, pixel_pos=pixel_pos) #input
    output = model(inputs=inputs, background=background, patch_pos=patch_pos, mask=mask) #retinextr
