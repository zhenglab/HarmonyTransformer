...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--light_element', type=int, default=9, help='resblocks')
        ...
        parser.add_argument('--relighting_action', type=str, default='relighting', help='weight for L1 loss')
